# =====================================================================
# wrds_utils.py
# Maintains a single in-process WRDS connection (one Duo 2FA per session) and
# wraps common CRSP/Compustat/CCM queries.
#
# Role:    Shared utility module (imported by analysis scripts in code/empirical/).
# Provides: Direct WRDS connection + query helpers (CRSP monthly, Compustat annual, CCM link, market index)
# =====================================================================
