# =====================================================================
# openalex.py
# CLI for querying the OpenAlex bibliographic database for finance/economics
# literature (search, citations, references, authors, works, venues).
#
# Role:    Shared utility module (imported by analysis scripts in code/empirical/).
# Provides: OpenAlex literature-scouting CLI (keyword search, forward/backward citations, author works, venue resolution)
# =====================================================================
