# =====================================================================
# fred_utils.py
# Configured FRED connection (via fredapi) for downloading macroeconomic
# time series and computing standard calibration moments.
#
# Role:    Shared utility module (imported by analysis scripts in code/empirical/).
# Provides: FRED series download + macro-moment helpers (mean/std/autocorr for GDP, inflation, rates, etc.)
# =====================================================================
