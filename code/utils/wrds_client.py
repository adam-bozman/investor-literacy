# =====================================================================
# wrds_client.py
# Client that sends SQL queries to the persistent wrds_server over a local
# TCP socket, starting the server (and Duo 2FA) on demand.
#
# Role:    Shared utility module (imported by analysis scripts in code/empirical/).
# Provides: WRDS client API (wrds_query/ping/start/list_tables/describe over the persistent server socket)
# =====================================================================
