# =====================================================================
# process_crsp_daily.py
# Cleans raw CRSP daily data into an analysis-ready panel (share/exchange
# filters, market cap, NYSE breakpoints, excess returns, FF factor merge).
#
# Role:    Shared utility module (imported by analysis scripts in code/empirical/).
# Provides: CRSP daily processing (filtering, ME, NYSE size breakpoints, excess returns, FF daily merge)
# =====================================================================
