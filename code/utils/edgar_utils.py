# =====================================================================
# edgar_utils.py
# Configured access to SEC EDGAR via edgartools and the SEC data APIs for
# company lookup, filing search, and XBRL financial facts.
#
# Role:    Shared utility module (imported by analysis scripts in code/empirical/).
# Provides: SEC EDGAR access (company/filing lookup, full-text filing search, XBRL companyfacts parsing)
# =====================================================================
