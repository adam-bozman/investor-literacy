# =====================================================================
# wrds_server.py
# Persistent WRDS connection server: connects once (one Duo 2FA) and serves
# SQL queries to clients over a local TCP socket.
#
# Role:    Shared utility module (imported by analysis scripts in code/empirical/).
# Provides: Persistent WRDS server daemon (socket query/list_tables/describe handler, sqlalchemy raw_sql bug workaround)
# =====================================================================
