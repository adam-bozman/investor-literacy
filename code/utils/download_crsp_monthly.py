# =====================================================================
# download_crsp_monthly.py
# Downloads the CRSP monthly stock file, CRSP-Compustat link table, FF
# factors, and WRDS firm ratios from WRDS.
#
# Role:    Shared utility module (imported by analysis scripts in code/empirical/).
# Provides: CRSP monthly + CCM link + FF monthly + WRDS ratios download helpers (via the persistent WRDS server)
# =====================================================================
