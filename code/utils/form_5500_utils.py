# =====================================================================
# form_5500_utils.py
# Downloads, caches, and joins DOL EBSA Form 5500 public-use research files
# (main form plus schedules) for ERISA pension/welfare plans.
#
# Role:    Shared utility module (imported by analysis scripts in code/empirical/).
# Provides: Form 5500 download + schedule join helpers (DOL EBSA ZIP fetch/cache, Schedule H asset panels)
# =====================================================================
