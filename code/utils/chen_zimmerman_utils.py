# =====================================================================
# chen_zimmerman_utils.py
# Wraps the openassetpricing package to download Chen-Zimmerman Open Source
# Asset Pricing signals and portfolio returns.
#
# Role:    Shared utility module (imported by analysis scripts in code/empirical/).
# Provides: Open Source Asset Pricing data access (firm-level signals, portfolio returns, signal documentation)
# =====================================================================
