# =====================================================================
# download_crsp_daily.py
# Downloads the CRSP daily stock file and Fama-French daily factors from
# WRDS year-by-year with parquet caching.
#
# Role:    Shared utility module (imported by analysis scripts in code/empirical/).
# Provides: CRSP daily + FF daily factor download/caching helpers (via the persistent WRDS server)
# =====================================================================
