# =====================================================================
# openalex_check.py
# Verifies bibliography citations against the OpenAlex API, matching by
# title similarity and flagging year mismatches.
#
# Role:    Shared utility module (imported by analysis scripts in code/empirical/).
# Provides: OpenAlex citation-verification CLI (stdin JSON/plain citations -> VERIFIED/RESOLVED/MISS results)
# =====================================================================
