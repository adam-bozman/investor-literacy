# =====================================================================
# process_crsp_monthly.py
# Cleans raw CRSP monthly data into analysis-ready panels (delisting-adjusted
# returns, market cap, lagged NYSE breakpoints) and basic return signals.
#
# Role:    Shared utility module (imported by analysis scripts in code/empirical/).
# Provides: CRSP monthly processing (delisting adjustment, ME, lagged NYSE breakpoints, STreversal/Price/Size signals)
# =====================================================================
