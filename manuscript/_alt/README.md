This folder archives the older, alternate version of the paper that was
superseded by the canonical manuscript (manuscript/main.tex, derived from
the project's main_v2.tex).
  ...
  sections/  - the bare (non-_v2) section files this alternate \input{}s,
               ...
               table2_migration.tex scratch fragments.

Kept for provenance only; not part of the submission.
